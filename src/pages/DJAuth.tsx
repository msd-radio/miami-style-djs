      ...
      >
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 rounded-lg border border-border bg-foreground text-background font-heading font-semibold hover:opacity-90 transition-opacity"
          >
