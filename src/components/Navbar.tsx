    ...
    >
      <div className="container mx-auto flex items-center justify-between h-16 px-4">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link
            to="/dj-registration"
            className="px-5 py-2 rounded-lg border border-primary text-primary font-heading font-bold text-sm uppercase tracking-wider hover:scale-105 transition-transform"
          >
            DJ Registration
          </Link>
          <Link
